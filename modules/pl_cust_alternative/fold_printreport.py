...
class AltFoldReport(Report):
    __name__ = 'pl_cust_alternative.foldreport'
    ...
    def get_context(cls, records, headers, data):
        ...
        context['start'] = my_format_date(context['folder'].date_start)        
        return context